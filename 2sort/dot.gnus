...
(defun erley/message-mode-hook ()
  ...
  (orgstruct++-mode 1)
  (flyspell-mode 1))
(add-hook  'message-mode-hook 'erley/message-mode-hook)

(defun erley/mime/editor-mode-hook ()
...
(add-hook 'mime/editor-mode-hook 'erley/mime/editor-mode-hook)

(defun erley/gnus-article-display-hook ()
  ...
  (article-emphasize))
(add-hook 'gnus-article-display-hook 'erley/gnus-article-display-hook)

(defun erley/gnus-summary-mode-hook ()
;;  (local-set-key [tab] 'gnus-summary-next-unread-article)
  (save-excursion
    (goto-char (point-min))))
(add-hook 'gnus-summary-mode-hook 'erley/gnus-summary-mode-hook)
